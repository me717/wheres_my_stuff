 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Max Mujica");
		  toPrint += p1.toString("mmujica6");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Jacob Waddell");
		  toPrint += p2.toString("jwaddell9");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Andrew Dehn");
		  toPrint += p3.toString("adehn3");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Albert Morlan");
          toPrint += p4.toString("amorlan3");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Emily Ritter");
          toPrint += p5.toString("eritter3");
